...
INSERT INTO email_template (id,titulo,mensagem,dt_created_at) VALUES (1,'{tb_tipo_ocorrencia->nm_tipo_ocorrencia}','<b>Notificação de Ocorrência</b> <br><br> <b>{tb_tipo_ocorrencia->nm_tipo_ocorrencia}</b><br>{nm_outro_motivo} <br><br> <b>Empresa:</b> <br> {system_users->tb_empresa->nm_empresa} <br><br> <b>Local:</b> <br> {system_users->tb_empresa->ds_endereco},{system_users->tb_empresa->cd_numero} - {system_users->tb_empresa->nm_bairro} - {system_users->tb_empresa->tb_cidade->nm_cidade} / {system_users->tb_empresa->tb_cidade->tb_uf->sg_uf} <br><br> <b>Gravidade:</b> <br> {tb_gravidade->nm_gravidade} <br><br> <b>Vítimas:</b> <br> {qt_vitimas} <br><br> <b>Resumo:</b> <br> {ds_resumo} <hr> <b>Ocorrência relatada por:</b> <br> {system_users->name} - {system_users->nm_cargo} <br><br> <b>Telefone:</b> <br> {system_users->cd_telefone} <br><br> <b>E-mail:</b> <br> {system_users->login}',null); 

INSERT INTO email_template (id,titulo,mensagem,dt_created_at) VALUES (2,'{tb_tipo_ocorrencia->nm_tipo_ocorrencia}','<b>Notificação de Ocorrência</b> <br><br> <b>{tb_tipo_ocorrencia->nm_tipo_ocorrencia}</b><br>{nm_outro_motivo} <br><br> <b>Empresa:</b> <br> {tb_empresa->nm_empresa} <br><br> <b>Local:</b> <br> {ds_endereco} <br><br> <b>Gravidade:</b> <br> {tb_gravidade->nm_gravidade} <br><br> <b>Vítimas:</b> <br> {qt_vitimas} <br><br> <b>Resumo:</b> <br> {ds_resumo} <hr> <b>Ocorrência relatada por:</b> <br> {system_users->name} - {system_users->nm_cargo} <br><br> <b>Telefone:</b> <br> {system_users->cd_telefone} <br><br> <b>E-mail:</b> <br> {system_users->login}',null); 

INSERT INTO email_template (id,titulo,mensagem,dt_created_at) VALUES (3,'{tb_tipo_ocorrencia->nm_tipo_ocorrencia}','<b>Notificação de Ocorrência</b> <br><br> <b>{tb_tipo_ocorrencia->nm_tipo_ocorrencia}</b><br>{nm_outro_motivo} <br><br> <b>Empresa:</b> <br> {system_users->tb_empresa->nm_empresa} <br><br> <b>Local:</b> <br> {ds_endereco} <br><br> <b>Gravidade:</b> <br> {tb_gravidade->nm_gravidade} <br><br> <b>Vítimas:</b> <br> {qt_vitimas} <br><br> <b>Resumo:</b> <br> {ds_resumo} <hr> <b>Ocorrência relatada por:</b> <br> {system_users->name} - {system_users->nm_cargo} <br><br> <b>Telefone:</b> <br> {system_users->cd_telefone} <br><br> <b>E-mail:</b> <br> {system_users->login}',null); 

INSERT INTO email_template (id,titulo,mensagem,dt_created_at) VALUES (4,'{tb_tipo_ocorrencia->nm_tipo_ocorrencia}','<b>Notificação de Ocorrência</b> <br><br> <b>{tb_tipo_ocorrencia->nm_tipo_ocorrencia}</b><br>{nm_outro_motivo} <br><br> <b>Empresa:</b> <br> {tb_empresa->nm_empresa} <br><br> <b>Local:</b><br> {system_users->tb_empresa->ds_endereco},{system_users->tb_empresa->cd_numero} - {system_users->tb_empresa->nm_bairro} - {system_users->tb_empresa->tb_cidade->nm_cidade} / {system_users->tb_empresa->tb_cidade->tb_uf->sg_uf} <br><br> <b>Gravidade:</b> <br> {tb_gravidade->nm_gravidade} <br><br> <b>Vítimas:</b> <br> {qt_vitimas} <br><br> <b>Resumo:</b> <br> {ds_resumo} <hr> <b>Ocorrência relatada por:</b> <br> {system_users->name} - {system_users->nm_cargo} <br><br> <b>Telefone:</b> <br> {system_users->cd_telefone} <br><br> <b>E-mail:</b> <br> {system_users->login}',null); 
...
INSERT INTO system_users (id,name,login,password,email,cd_telefone,nm_cargo,frontpage_id,system_unit_id,active,accepted_term_policy_at,accepted_term_policy,tb_empresa_id,tb_cidade_id,tb_area_porto_id) VALUES (1,'Administrator','admin','21232f297a57a5a743894a0e4a801fc3','admin@admin.net',null,null,10,null,'Y','','',null,null,null); 

INSERT INTO system_users (id,name,login,password,email,cd_telefone,nm_cargo,frontpage_id,system_unit_id,active,accepted_term_policy_at,accepted_term_policy,tb_empresa_id,tb_cidade_id,tb_area_porto_id) VALUES (2,'User','user','ee11cbb19052e40b07aac0ca060c23ee','user@user.net',null,null,7,null,'Y','','',null,null,null); 
